...
# 训练数据集存放路径
img_folder_path = '/content/drive/MyDrive/my_clip_finetune/dataset/my_CIFAR10/my_train_cifar10_afterLIIF_x2'
...
def train():
    ...
    # 保存model和组件
    sava_model_components('/content/drive/MyDrive/my_clip_finetune/models/model_components2.pth', model, optimizer)
